  ...
  return (
    ...
    <div className="min-h-screen bg-slate-900 text-gray-100 font-sans selection:bg-purple-500 selection:text-white">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            {["Home", "About", "Experience", "Projects", "Contacts"].map(
              (item) => (
                <button
                  key={item}
            ...
            <button className="bg-purple-600 text-white px-6 py-2 rounded-full font-medium hover:bg-purple-500 transition-all shadow-lg hover:shadow-purple-500/30 border border-purple-500">
              Telegram
            </button>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-slate-800 border-b border-white/10 shadow-xl">
            <div className="flex flex-col p-6 gap-4">
              ...
              <button className="bg-purple-600 text-white w-full py-3 rounded-lg font-medium mt-2 hover:bg-purple-500 transition-colors">
                Download CV
              </button>
            </div>
          </div>
      ...
      <main>
        ...
        <section
          id="about"
          className="min-h-screen bg-slate-800/50 border-t border-white/5"
        >
        ...
        <section
          id="projects"
          className="min-h-screen bg-slate-900 border-t border-white/5"
        >
          <div className="w-full flex items-center justify-center min-h-screen">
            <Project />
          </div>
