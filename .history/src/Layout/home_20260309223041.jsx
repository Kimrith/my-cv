        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-slate-800 border-b border-white/10 shadow-xl">
            <div className="flex flex-col p-6 gap-4">
              ...
              <a
                href="https://t.me/@CheyKimrith"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-purple-600 text-white w-full py-3 rounded-lg font-medium mt-2 hover:bg-purple-500 transition-colors text-center"
              >
                Telegram
              </a>
            </div>
