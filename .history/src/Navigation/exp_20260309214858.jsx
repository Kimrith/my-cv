    ...
    <div className="py-20 w-full flex justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl px-4 relative z-10">
        ...
        <div className="relative group">
          ...
          <div className="relative bg-slate-800/50 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
              {[
                { name: "Frontend", color: "purple", count: 4 },
                { name: "Backend", color: "blue", count: 3 },
                { name: "Database", color: "emerald", count: 2 },
                { name: "Tools", color: "red", count: 5 },
                { name: "Concepts", color: "yellow", count: 6 },
              ].map((cat) => (
                <div
                  key={cat.name}
                  className="bg-slate-700/30 rounded-lg p-3 text-center border border-white/5"
                >
                  <div
                    className={`text-${cat.color}-400 text-xs font-medium mb-1`}
                  >
                    {cat.name}
                  </div>
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={tech}
                  className="group/tech relative px-4 py-2 bg-slate-700/30 border border-white/10 rounded-lg text-sm text-gray-300 hover:text-purple-300 transition-all duration-300 overflow-hidden"
                >
                  <span className="relative z-10 flex items-center gap-1.5">
                    <span className="w-1.5 h-1.5 rounded-full bg-purple-400 group-hover/tech:scale-150 transition-transform"></span>
                    {tech}
                  </span>
                  <span className="absolute inset-0 bg-gradient-to-r from-purple-600/20 to-transparent opacity-0 group-hover/tech:opacity-100 transition-opacity"></span>
                </span>
              ))}
            </div>
