...
const Experience = () => {
  ...
  const ExperienceCard = ({ exp }) => (
    <div className="w-full bg-slate-800/30 border border-white/5 rounded-xl p-6 hover:border-purple-500/30 transition-all hover:translate-y-[-2px]">
  ...
  return (
    <div className="mt-16 w-full">
      {/* Section Header - matching your About Me header style */}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6 text-center items-center justify-center">
