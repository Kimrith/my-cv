    ...
    education: [
      {
        ...
        description: "Building full-stack web applications using Angular, Node.js, and MongoDB. Developing admin dashboards and customer-facing interfaces with user authentication, CRUD operations, and e-commerce functionality.",
        achievements: [
    ...
    work: [
      {
        ...
        description: "Contributed to frontend development projects, gaining practical experience in building responsive web applications within a government environment.",
        achievements: [
  ...
  return (
    <div className="mt-16">
        ...
        <div className="space-y-8">
          ...
          <div className="relative">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-xl font-semibold text-white">Academic Projects</h3>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
      ...
      <div className="mt-8 bg-slate-800/20 border border-white/5 rounded-xl p-6">
        <h4 className="text-sm font-medium text-gray-400 mb-3">Technologies I've worked with:</h4>
        <div className="flex flex-wrap gap-2">
          {['Angular', 'Node.js', 'MongoDB', 'RESTful APIs', 'Authentication', 'CRUD', 'E-commerce', 'Admin Dashboard'].map((tech) => (
            <span key={tech} className="px-3 py-1.5 bg-purple-900/20 border border-purple-500/20 rounded-lg text-xs text-purple-300">
              {tech}
            </span>
          ))}
        </div>
