  ...
  return (
    <div className="space-y-16">
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-8">
        ...
        {/* Skills Overview */}
        <div className="bg-gradient-to-r from-emerald-50 to-blue-50 p-6 rounded-2xl mb-10">
          <div className="flex flex-wrap items-center justify-between gap-6">
            ...
            <div className="flex gap-3">
              <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm border border-emerald-200">
        ...
        {/* Summary Section */}
        <div className="mt-10 bg-gradient-to-r from-emerald-600 to-blue-600 rounded-2xl p-8 text-white">
